import { House, ContactRound, Ticket, LogOut, X } from "lucide-react";
...
const mainMenu: MenuItem[] = [
  { label: "Profile", icon: ContactRound, href: "/dashboard/user-information" },
  { label: "Dashboard", icon: House, href: "/dashboard/my-ticket" },
  ,
];

export default function SidebarUser({ open, onClose }: SidebarAdminProps) {
  return (
    <>
      {/* Overlay (mobile) */}
      {open && (
