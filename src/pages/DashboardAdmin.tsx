...
import { Calendar, Users, DollarSign, ChartColumn } from "lucide-react";
      ...
      <div className="min-h-screen flex flex-col bg-muted/30">
        <main className="flex-1 max-w-7xl mx-auto w-full px-6 py-10">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-10">
            ...
            {/* <Button
              onClick={() => navigate("/dashboard/admin-event")}
              className="rounded-full gap-2 bg-primary hover:bg-primary/90 transition-all duration-200 hover:scale-[1.03] active:scale-[0.97] shadow"
            >
